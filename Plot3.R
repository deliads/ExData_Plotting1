...
## Plot 3
png("ExData/Plot3.png", width=480, height=480, bg='transparent')  
...
lines(finalData$Time, finalData$Sub_metering_2, type = "l", col = colorsLines[2])
lines(finalData$Time, finalData$Sub_metering_3, type = "l", col = colorsLines[3])
legend("topright", legend = labels, col = colorsLines, lty = "solid")
dev.off()
